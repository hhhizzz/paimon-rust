...
use crate::spec::{
    ...
    GlobalIndexSearchMode, IndexManifest, ManifestEntry, PartitionComputer, Predicate, Snapshot,
...
impl<'a> TableScan<'a> {
    ...
    async fn plan_snapshot(
        ...
        let stats_pruning_predicates = super::scan_manifest_planner::stats_pruning_predicates(
            self.table,
...
#[cfg(test)]
mod tests {
    use super::{prune_data_evolution_group_by_read_fields, LimitPushdownAccumulator, TableScan};
